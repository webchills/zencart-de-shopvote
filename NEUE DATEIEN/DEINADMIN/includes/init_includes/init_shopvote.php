 ...
 * @version $Id: init_shopvote.php 2017-06-13 12:13:51Z webchills $
 */
if (!defined('IS_ADMIN_FLAG')) {
    die('Illegal Access');
}

$module_constant = 'SHOPVOTE_MODUL_VERSION'; 
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/shopvote'; 
$module_name = "Shopvote"; 
